...
class GetListOfLanguages @Inject constructor(private val repository: TranslationRepository) {
    operator fun invoke(): Flow<ResourceState<List<Language>>> {
        return repository.getListOfLanguages()
    }
}